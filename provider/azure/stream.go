...
// handleStream processes the Azure OpenAI stream and sends events to the chat stream
// (Identical to OpenAI provider stream handling)
func (p *AzureProvider) handleStream(
	ctx context.Context,
